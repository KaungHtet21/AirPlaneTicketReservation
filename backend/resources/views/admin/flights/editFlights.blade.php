...
@section('contenteps')
    ...
    <div class="container flightBox">
        ...
        <div class="col-md-1 offset-11 mt-3">
        ...
        <form action='{{ route('update#flight', $id) }}' method='POST'>
            ...
            <div class="mb-3">
                ...
                <input type="string" name='distance' value='{{ $flight->flight_distance }}' class="form-control"
                    id="distance">
                @if ($errors->has('distance'))
                    <small class="text-danger">The arrive time field is required.</small>
                @endif
            </div>   <div class="ml-3 mt-5 row ">
                <div class="col-md-6">
            ...
            <button type="submit" class="offset-10 btn btn-primary updateBtn">Update Flight</button>
